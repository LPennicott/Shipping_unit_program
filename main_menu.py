...
#Main window to stay active for duration of the program. Other options occur in Multi-window.
...
if event == 'save_new':
    ...
    try:
        ...
        layout2 = [[sg.Text('Shipping Unit not found! Click below to view shipments.')],
        [sg.Submit()]]
        sg.change_look_and_feel('DarkBlue')
